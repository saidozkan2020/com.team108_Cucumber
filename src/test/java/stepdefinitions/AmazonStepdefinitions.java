...
public class AmazonStepdefinitions {
    ...
    public void arama_sonuclarinin_nutella_icerdigini_test_eder() {
        ...
        String actualAramaSonucYasizi =amazonPage.aramaSonucElementi.getText();
        Assert.assertTrue(actualAramaSonucYasizi.contains(expectedIcerik));
    ...
    public void sonuclarinIcerdiginiTestEder(String arananKelime) {
        String actualAramaSonucYasizi =amazonPage.aramaSonucElementi.getText();
        Assert.assertTrue(actualAramaSonucYasizi.contains(arananKelime));
